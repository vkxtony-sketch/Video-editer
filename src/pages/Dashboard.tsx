      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Open a project to keep editing, or start a new run.
          </p>
        </div>
...
function EmptyState() {
  return (
    <div className="rounded-xl border border-dashed border-border/70 bg-card/40 p-10 text-center">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Spin up your first pipeline — choose a duration, persona, and
        source. We'll chunk, scan, transcribe, and edit it for you.
      </p>
    </div>
  );
}
      ...
      <DialogContent className="border-border/80 bg-card/95 backdrop-blur-xl">
        ...
        <div className="space-y-5 pt-2">
          ...
          <div>
            ...
            {sourceKind === "upload" && (
              <div className="mt-2 rounded-lg border border-dashed border-border/70 bg-secondary/30 p-4 text-center text-xs text-muted-foreground">
                <Upload className="mx-auto h-4 w-4" />
                Upload UI is wired via Convex file storage in this demo build —
                for huge VODs we recommend URL import.
              </div>
            )}
          </div>
          ...
          <div className="flex items-center justify-between gap-3 border-t border-border/60 pt-3">
            <p className="text-xs text-muted-foreground">
              ...
              thumbnails. Honest demo labelling in the UI.
            </p>
